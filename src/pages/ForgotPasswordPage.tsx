      ...
      <Layout>
        <div className="mx-auto max-w-md py-16 px-4 sm:px-6">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm text-center">
            ...
            <h1 className="text-2xl font-bold font-sg text-[#133c1d]">Check your inbox</h1>
            <p className="mt-3 text-sm text-muted-foreground leading-relaxed">
              If an account with that email exists, we've sent a password reset link.
              The link expires in 1 hour.
            </p>
            <Link to="/login">
              <Button className="mt-8 h-11 w-full rounded-xl text-base font-medium" variant="outline">Back to Sign in</Button>
            </Link>
          </div>
        </div>
      </Layout>
      ...
      <div className="mx-auto max-w-md py-16 px-4 sm:px-6">
        <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold font-sg text-[#133c1d]">Forgot password</h1>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <Button type="submit" disabled={isLoading || isRateLimited} className="mt-2 h-11 w-full rounded-xl text-base font-medium bg-[#8cc63f] hover:bg-[#7ab32e] text-[#133c1d]">
