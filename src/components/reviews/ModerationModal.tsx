    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg rounded-[24px] bg-white shadow-[0_25px_80px_rgba(0,0,0,0.18)] p-6">
        ...
        <div className="mb-5 rounded-[16px] bg-[#f5faf0] p-4">
          ...
          {review.title && <p className="text-sm font-bold text-[#133c1d] mb-1">{review.title}</p>}
          <p className="text-sm font-medium text-gray-700 leading-relaxed line-clamp-4">{review.content}</p>
